...
<head>
    ...
    <title>Types d'operations — Mobile Money</title>
    ...
    <div class="app-shell">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?= site_url('type-operation') ?>" class="sidebar-nav-item active">
                    <svg class="icon" viewBox="0 0 24 24">
        ...
        <div class="main">
            <header class="topbar">
                ...
                <a href="<?= site_url('type-operation/create') ?>" class="btn btn-accent btn-sm">
                    <svg class="icon icon-sm" viewBox="0 0 24 24">
