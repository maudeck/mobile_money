                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('operateur/store') ?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="code_prefixe" name="code_prefixe" value="<?= old('code_prefixe') ?>" required>
                                <div class="form-text">Ex: 033, 034, 038</div>
                            </div>
                            <div class="mb-3">
                                <label for="operateur_nom" class="form-label">Nom Opérateur</label>
                                <input type="text" class="form-control" id="operateur_nom" name="operateur_nom" value="<?= old('operateur_nom') ?>" required>
                            </div>
